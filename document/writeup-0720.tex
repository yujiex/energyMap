...
environmental impact. The section will present some more detailed
examples in each use cases.
\subsubsection{Supply side: Assessing renewable energy potential}
Voivontas et al. developed a decision support tool using GIS for
accessing the wind energy potential in terms of theoretical potential
of wind speed, availability potential in terms of landuse regulations
and technological potential in terms of energy production features of
wind turbine and economical potential in terms of IRR.

Ramachandra and Shruthi produced an energy potential map on various
renewable energy sources such as solar, wind, biomass and hydroenergy.
  ...
  \item ``NYC City Solar Map'': present solar energy potential for
    ...
    \end{enumerate}
\subsubsection{Supply and Demand Side: Analysis or design support of existing energy infrastructures}
    \begin{enumerate}[label*=\arabic*.]
    ...
    \end{enumerate}
\subsubsection{Demand Side: Energy consumption prediction model}
    \begin{enumerate}[label*=\arabic*.]
      \item ``A large-scale study on predicting and contextualizing building energy usage'', Kolter, J. Zico; Ferreira Jr, Joseph.
    \end{enumerate}
\subsubsection{Demand Side: Smart Management of Urban Energy System}
    \begin{enumerate}[label*=\arabic*.]
