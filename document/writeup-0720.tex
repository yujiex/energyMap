...
Energy Map with a use case senario of supporting district
...
rejected heat or coolth in the process of electricity generation, more
efficient energy generation equipment than stand-alone system, and by
using waste in energy generation.

Dynamic Energy Map support district energy system design by revealing
the non-coherant peak demand of heat and electricity.
For this scenario, we identify ``demand side'', 

In this use case, we define our Dynamic Energy Map as:
\begin{itemize}
\item A database holding 8760-hour meta data of energy demand
  ~\cite{baird2014}.
\item An interface that has multi-dimensional graphical display of
...
\section{Objective}
\subsection{Exploring a potential use case of Dynamic Energy Map in
  Community Planning 
  Design Support}
