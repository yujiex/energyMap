...
\abstract{\addtocontents{toc}{\vspace{1em}} % Add a gap in the Contents, for aesthetics
  ...
  research interests of this user group.
  ...
  Commercial Prototype Building ASHRAE90.1-2013. The interface is
  written in Python.
...
Institute for her kindly help in helping me understand more about the
