...
suppliers and consumers over time (\fref{fig:highCooling}).
...
Users can then calculate the ``energy recovery potential'' of the
...
\fref{fig:ERP}, the energy recovery potential and space heating demand
